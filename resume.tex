...
\location{April 2013 – June 2013 | \href{https://www.google-melange.com/}{Google Melange}}
\begin{tightemize}
...
\location{Feb 2014 – April 2014 |
  \href{https://github.com/rihbyne/app_control_client}{homeAutomationApp} | \href{https://github.com/rihbyne/control_server_api}{control-servo}}
\begin{tightemize}
...
\item The request routing logic is written on top of Express middleware
  framework and deployed on \custombold{Node.js }application server running on embedded device.
