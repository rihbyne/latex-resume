...
\item  Solid exposure in logical and persistence tier of their multi-tier
  architecture. Currently developing tool for processing Bitcoins which
  compliments manual labour.
...
\item Produced comprehensive documentation
\end{tightemize}
\sectionsep
...
\item  Excercised acquired understanding of DVCS tool
  \href{http://swlogs.me/blog/git-workflow/}{\textbf{Git}}, learned to resolve
...
\runsubsection{GSOC 2013}
\descript{| participant}
\location{April 2013 – June 2013 | Google Melange}
\begin{tightemize}
\item Drafted project prosopal to implement Software Bug Reporting tool
  for OSS organization \href{http://code.timvideos.us/home/}{\textbf{Tim Videos}}.
\end{tightemize}
\sectionsep
